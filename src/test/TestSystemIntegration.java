...
public class TestSystemIntegration {
    ...
    public static void main(String[] args) {
        ...
        FrontDeskServiceControl frontDeskControl = new FrontDeskServiceControl(guestDirectory, roomTable);
        ...
        boolean failRedeem = redeemGuest.redeemPointsForStay(Room.TYPE_SUITE);
